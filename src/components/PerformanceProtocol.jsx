        ...
        <div className="flex flex-col md:flex-row items-start justify-between mb-20 gap-12">
          <div className="max-w-3xl">
            ...
            <h2 className="text-5xl md:text-8xl font-light tracking-tighter text-white leading-[0.9] uppercase italic pt-1 flex flex-col">
              ...
              <span className="inline-block bg-gradient-to-b from-[#00bffa] via-[#00bffa] to-[#005eea] bg-clip-text text-transparent not-italic font-bold drop-shadow-[0_0_15px_rgba(0,191,250,0.4)] -mt-4 md:-mt-10 pt-2 pb-1 pr-4 md:pr-8 leading-normal">
                {t.title_part2}
              </span>
            </h2>
          </div>
