        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {t.plans.map((item, idx) => (
            <motion.div
              ...
              className={`p-8 md:p-16 rounded-[32px] relative flex flex-col ${item.highlight ? 'bg-zinc-900/50 border border-white/5 shadow-[0_0_60px_rgba(0,191,250,0.05)]' : 'glass-card'}`}
            >
              {item.highlight && (
